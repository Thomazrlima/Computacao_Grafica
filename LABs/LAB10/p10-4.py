...
class Example(Base):
    ...
    def initialize(self):
        ...
        directional_light_helperB = DirectionalLightHelper(self.directional_lightB)
        self.directional_lightB.add(directional_light_helperB)
    ...
    def update(self):
        ...
        self.directional_lightB.set_direction([1, math.sin(0.5 * self.time), 0])
